...
```
<!-- Titulo del tablaro -->
\fontsize{20}{20} \selectfont \textcolor{mygreen}{Principales alimentos en centrales de abasto de Medellín, por volumen de ingreso}\
<!-- Subtitulo -->
\fontsize{10}{10} \selectfont \textcolor{green2}{Visualiza los alimentos más destacados en las centrales de abasto de Medellín, basado en su volumen de entrada}\
<!-- Subtitulo dinamico -->
...
\fontsize{8}{8} \selectfont \textcolor{mygreen}{Solo se muestran los productos que tienen al menos un 1\% de la composición.}\
