...
ui <- fluidPage(
  ...
  div(class = "scrollable-content",
      fluidRow(
        column(4,
               selectInput("año", "Seleccione el año:", c("Todos los años" = "todo", sort(unique(entran$anio))))),
        column(4,
        ...
        column(4,
               selectInput("depto", "Seleccione el departamento", c("Total nacional" = "todo", sort(unique(entran$depto_origen)))))
      )),
  div(
    fluidRow(
      column(9,
             ...
             shiny::a("GitHub", href="https://github.com/Simonaa-Antioquia/Tableros/tree/6d5307028a7922c6a94ecf6c501d6db97049cf42/Abs5", target="_blank",
