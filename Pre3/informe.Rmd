...
```
<!-- Titulo del tablaro -->
\fontsize{20}{20} \selectfont \textcolor{mygreen}{Análisis de precios de alimentos por ciudad}\newline
<!-- Subtitulo -->
\fontsize{15}{15} \selectfont \textcolor{mygreen}{Descubre las diferencias de precios de alimentos en ciudades, comparadas con Medellín}\newline
<!-- Subtitulo2 -->
