...
```
<!-- Titulo del tablaro -->
\fontsize{20}{20} \selectfont \textcolor{mygreen}{Contribución de Antioquia al Abastecimiento Nacional}\
<!-- Subtitulo -->
\fontsize{10}{10} \selectfont \textcolor{green2}{Análisis de la participación de Antioquia en el abastecimiento de alimentos en otros departamentos del país}\
<!-- Subtitulo dinamico -->
