...
df <- data.frame(
  "Parametro" = c("Temporalidad","Variable", "Año", "Alimento"),
  "Valor" = c(tiempo_label,tipo_label, ifelse(is.na(params$anio) | params$anio == "todo", "Todos los años", params$anio), ifelse(is.na(params$alimento) | params$alimento == "todo", "Todos los productos", params$alimento))
)
...
tabla_kable <- df %>%
  ...
  kable_styling(full_width = FALSE, latex_options = "HOLD_position", position = "left",bootstrap_options = "striped")  # Estilo de la tabla con bordes blancos y cuadrícula completa
...
<!-- Titulo del tablaro -->
\fontsize{20}{20} \selectfont \textcolor{mygreen}{Comportamiento de los precios en el tiempo}\
<!-- Subtitulo -->
\fontsize{15}{15} \selectfont \textcolor{green2}{Análisis histórico de precios de alimentos en las centrales de abasto de Medellín}\
<!-- Subtitulo2 -->
