...
df <- data.frame(
  "Parametro" = c("Variable", "Año", "Alimento"),
  "Valor" = c(tipo_label, ifelse(is.na(params$anio) | params$anio == "todo", "Todos los años", params$anio), ifelse(is.na(params$alimento) | params$alimento == "todo", "Todos los productos", params$alimento))
)
...
<!-- Subtitulo -->
\fontsize{15}{15} \selectfont \textcolor{mygreen}{Análisis histórico de precios de alimentos en las centrales de abasto de Medellín}\
<!-- Subtitulo2 -->
