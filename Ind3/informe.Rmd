...
```
<!-- Titulo del tablaro -->
\fontsize{20}{20} \selectfont \textcolor{mygreen}{índice de diversidad de destino de los alimentos}\
<!-- Subtitulo -->
\fontsize{10}{10} \selectfont \textcolor{green2}{Análisis de la variedad de territorios conectados por el flujo de alimentos desde Antioquia hacia otras plazas en SIPSA.}\
<!-- Subtitulo dinamico -->
