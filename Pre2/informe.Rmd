...
tabla_kable <- df %>%
  ...
  kable_styling(full_width = FALSE, latex_options = "HOLD_position",  bootstrap_options = "striped", position = "left")  # Estilo de la tabla con bordes blancos y cuadrícula completa
...
```
<!-- Titulo del tablaro -->
\fontsize{20}{20} \selectfont \textcolor{mygreen}{Relación entre volúmenes y precios de los alimentos}\
<!-- Subtitulo -->
\fontsize{15}{15} \selectfont \textcolor{mygreen}{Evolución del precio promedio por Kg en relación al volumen de ingreso a las centrales de abasto de Medellín}\
<!-- Subtitulo2 -->
...
\AddToShipoutPictureBG*{\includegraphics[width=\paperwidth,height=5cm,keepaspectratio]{www/logo_2.png}}
