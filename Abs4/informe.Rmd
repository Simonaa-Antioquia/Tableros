...
df <- data.frame(
  "Parametro" = c("\\textbf{Año}", "Mes", "Número de municipios", "Alimentos"),
  "Valor" = c(
...
<!-- Titulo del tablaro -->
\fontsize{20}{20} \selectfont \textcolor{mygreen}{Destino de la producción de alimentos de origen antioqueño}\
\fontsize{10}{10} \selectfont \textcolor{green2}{Descubre las principales ciudades receptores de alimentos con origen Antioquia según el SIPSA}\
<!-- Grafica -->
