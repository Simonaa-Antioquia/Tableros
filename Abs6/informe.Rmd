...
```
<!-- Titulo del tablaro -->
\fontsize{20}{20} \selectfont \textcolor{mygreen}{Antioquia en los mercados: Principales productos por volumen}\
<!-- Subtitulo -->
\fontsize{10}{10} \selectfont \textcolor{green2}{Principales productos de Antioquia en otros mercados: volumen y composición de la 
canasta.}\
