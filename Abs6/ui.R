...
ui <- fluidPage(
  ...
  tags$h1("Antioquia en los mercados: Principales productos por volumen", class = "main-header"),
  tags$h1("Principales productos de Antioquia en otros mercados: volumen y composición de la canasta.", class = "main-header_2"),
  div(
  ...
  div(
    fluidRow(
      column(10,
             ...
             shiny::a("GitHub", href="https://github.com/Simonaa-Antioquia/Tableros/tree/6d5307028a7922c6a94ecf6c501d6db97049cf42/Abs6", target="_blank",
    ...
    tags$div(tags$p(" ",
                    ...
                    tags$br(),"Solo se muestran los productos que representan al menos un 0,5% del volumen total de productos de origen antioqueño reportado en las centrales de abasto del SIPSA.", class = "sub-header2"), style = "margin-top: 20px;")
  ),
  br(),
  br(),
  br(),
