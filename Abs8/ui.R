...
ui <- fluidPage(
  ...
  div(
    fluidRow(
      ...
      column(3,
             selectInput("año", "Seleccione el año:", c("Todos los años" = "todo", sort(unique(acum_total_anio$anio))))),
      column(3,
  ...
  fluidRow(
    column(9,
           div(
             ...
             shiny::a("GitHub", href="https://github.com/Simonaa-Antioquia/Tableros/tree/6d5307028a7922c6a94ecf6c501d6db97049cf42/Abs8", target="_blank",
