...
```
<!-- Titulo del tablaro -->
\fontsize{20}{20} \selectfont \textcolor{mygreen}{Antioquia y su importancia en la recepción de alimentos}\
<!-- Subtitulo -->
\fontsize{10}{10} \selectfont \textcolor{green2}{Descubre la importancia de Antioquia como receptor de alimentos desde otros departamentos del país.}\
<!-- Subtitulo dinamico -->
...
\fontsize{8}{8} \selectfont \textcolor{mygreen}{* Producción se refiere a los productos cuyo origen es Antioquia.}\ 
